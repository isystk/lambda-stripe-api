...
import { DynamoDBClient, DynamoDBRecord } from '../actions/dynamodb-client'
...
import { SmtpClient } from '../actions/smtp-client'
...
router.post('/cancel-confirm', async (req: Request, res: Response) => {
...
router.post('/active-check', async (req: Request, res: Response) => {
...
router.post('/customer', checkAuth, async (req: Request, res: Response) => {
  const { productId } = {
    productId: req.body['productId'],
  }
